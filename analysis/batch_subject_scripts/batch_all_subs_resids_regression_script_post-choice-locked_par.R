...
for(sub in subs){
  ...
  ## run regressions ##
  # # self var paroff #
  run_permuted_controlled_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = "trial_type", regressor_control = "self_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "hfa-post-choice-locked-unified-resids-selfp-cperm-hilbertRS")
  # other var payoff #
  run_permuted_controlled_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = "trial_type", regressor_control = "self_var_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "hfa-post-choice-locked-unified-resids-selfo-cperm-hilbertRS")
