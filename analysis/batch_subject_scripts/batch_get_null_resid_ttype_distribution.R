...
source(path(here(), "R", "get_null_resid_trial_type_dist.R"))
...
for(sub in subs){
  ...
  # run models #
  run_permuted_resid_ttype_null(brain_behave_data,
                               electrodes = all_electrodes,
                               regressors = c("self_var_payoff", "other_var_payoff"),
                               regressor_controls = c("self_var_payoff", "other_var_payoff"),
                               nBins,
                               niter,
                               sub = sub,
                               tag = "pres-null-ttype-permute-cperm-hilbertRS")
  ...
  run_permuted_resid_ttype_null(brain_behave_data,
                                ...
                                niter,
                                sub = sub,
                                tag = "pre-choice-null-ttype-permute-cperm-hilbertRS")
  ...
  run_permuted_resid_ttype_null(brain_behave_data,
                                ...
                                niter,
                                sub = sub,
                                tag = "post-choice-null-ttype-permute-cperm-hilbertRS")
