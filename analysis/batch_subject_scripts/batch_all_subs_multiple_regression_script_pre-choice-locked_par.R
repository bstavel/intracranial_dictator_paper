...
for(sub in subs){
  ...
  ## run regressions ##
  # # self  payoff #
  run_permuted_multiple_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = "trial_type", regressor_control = "self_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "hfa-pre-choice-locked-unified-multiple-selfp-cperm-hilbertRS")
  # self var payoff #
  run_permuted_multiple_regressions_par(brain_behave_data, electrodes = all_electrodes, regressor = "trial_type", regressor_control = "self_var_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "hfa-pre-choice-locked-unified-multiple-selfo-cperm-hilbertRS")
