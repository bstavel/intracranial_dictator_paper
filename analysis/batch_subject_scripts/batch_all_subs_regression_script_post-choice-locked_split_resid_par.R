...
for(freq in freqs){
  ...
  for(sub in subs){
    ...
    ## Advantageous ##
    # # self var paroff #
    run_permuted_controlled_regressions_par(brain_behave_data_adv, electrodes = all_electrodes, regressor = "self_var_payoff", regressor_control = "other_var_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "-post-choice-locked-adv-only-cperm-resid-hilbertRS")
    # other var payoff #
    run_permuted_controlled_regressions_par(brain_behave_data_adv, electrodes = all_electrodes, regressor = "other_var_payoff", regressor_control = "self_var_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "-post-choice-locked-adv-only-cperm-resid-hilbertRS")
    
    
    ## Disadvantageous ##
    ## Advantageous ##
    # # self var paroff #
    run_permuted_controlled_regressions_par(brain_behave_data_dis, electrodes = all_electrodes, regressor = "self_var_payoff", regressor_control = "other_var_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "-post-choice-locked-dis-only-cperm-resid-hilbertRS")
    # other var payoff #
    run_permuted_controlled_regressions_par(brain_behave_data_dis, electrodes = all_electrodes, regressor = "other_var_payoff", regressor_control = "self_var_payoff", nBins, region_name =  "All", niter, sub = sub, tag = "-post-choice-locked-dis-only-cperm-resid-hilbertRS")
