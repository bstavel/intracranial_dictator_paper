...
source(path(here(), "R", "get_null_trial_type_dist.R"))
...
for(sub in subs){
  ...
  run_permuted_ttype_null(brain_behave_data,
                               electrodes = all_electrodes,
                               regressors = regressors_to_use,
                               nBins,
                               niter,
                               sub = sub,
                               tag = "pres-null-ttype-permute-theta-cperm-hilbertRS")
  ...
  run_permuted_ttype_null(brain_behave_data,
                               ...
                               niter,
                               sub = sub,
                               tag = "pre-choice-null-ttype-permute-theta-cperm-hilbertRS")
  ...
  run_permuted_ttype_null(brain_behave_data,
                               ...
                               niter,
                               sub = sub,
                               tag = "post-choice-null-ttype-permute-theta-cperm-hilbertRS")
