...
source(path(here(), "R", "get_null_resid_average_r2_dist.R"))
...
for(sub in subs){
  ...
  # regs of interest #
  regressors_to_use <- c("self_var_payoff")
  ...
  # adv #
  run_permuted_null_resid_average_r2(brain_behave_data_adv,
                               permute_data = brain_behave_data,
                               electrodes = all_electrodes,
                               regressors = c("self_var_payoff", "other_var_payoff"),
                               regressor_controls = c("other_var_payoff", "self_var_payoff"),
                               nBins,
                               niter,
                               sub = sub,
                               tag = "pres-null-average-r2-adv-cperm-hilbertRS")
  

  # dis #
  run_permuted_null_resid_average_r2(brain_behave_data_dis,
                                     permute_data = brain_behave_data,
                                     electrodes = all_electrodes,
                                     regressors = c("self_var_payoff", "other_var_payoff"),
                                     regressor_controls = c("other_var_payoff", "self_var_payoff"),
                                     ...
                                     niter,
                                     sub = sub,
                                     tag = "pres-null-average-r2-dis-cperm-hilbertRS")
  ...
  run_permuted_null_resid_average_r2(brain_behave_data_adv,
                                     ...
                                     niter,
                                     sub = sub,
                                     tag = "pre-choice-null-average-r2-adv-cperm-hilbertRS")
  ...
  run_permuted_null_resid_average_r2(brain_behave_data_dis,
                                     ...
                                     niter,
                                     sub = sub,
                                     tag = "pre-choice-null-average-r2-dis-cperm-hilbertRS")
  ...
  run_permuted_null_resid_average_r2(brain_behave_data_adv,
                                     ...
                                     niter,
                                     sub = sub,
                                     tag = "post-choice-null-average-r2-adv-cperm-hilbertRS")
  ...
  run_permuted_null_resid_average_r2(brain_behave_data_dis,
                                     ...
                                     niter,
                                     sub = sub,
                                     tag = "post-choice-null-average-r2-dis-cperm-hilbertRS")
