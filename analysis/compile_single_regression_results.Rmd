...
# compile all unified encoding results by frequency band
...
presentation_results_57 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR57",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR57", "final", "theta"),
                                           freq = "theta")
...
presentation_results_35 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR35",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR35", "final", "theta"),
                                           freq = "theta")
...
presentation_results_28 <- compile_results(regions = regions_to_combine, 
                                           ...
                                           sub = "IR28", 
                                           spec_vars = spec_vars, 
                                           path = path(here(), "results", "IR28", "final", "theta"), 
                                           freq = "theta")
...
presentation_results_26 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR26",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR26", "final", "theta"),
                                           freq = "theta")
...
presentation_results_16 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR16",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR16", "final", "theta"),
                                           freq = "theta")
...
presentation_results_10 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR10",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR10", "final", "theta"),
                                           freq = "theta")
...
presentation_results_9 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR9",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR9", "final", "theta"),
                                           freq = "theta")
...
presentation_results_19 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR19",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR19", "final", "theta"),
                                           freq = "theta")
...
presentation_results_39 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "IR39",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "IR39", "final", "theta"),
                                           freq = "theta")
...
presentation_results_cp34 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "CP34",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "CP34", "final", "theta"),
                                           freq = "theta")
...
presentation_results_gp51 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "GP51",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "GP51", "final", "theta"),
                                           freq = "theta")
...
presentation_results_da9 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "DA9",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "DA9", "final", "theta"),
                                           freq = "theta")
...
presentation_results_st40 <- compile_results(regions = regions_to_combine,
                                           ...
                                           sub = "ST40",
                                           spec_vars = spec_vars,
                                           path = path(here(), "results", "ST40", "final", "theta"),
                                           freq = "theta")
...
#                                            sub = "DA8",
#                                            spec_vars = spec_vars,
#                                            path = path(here(), "results", "DA8", "final", "theta"),
#                                            freq = "theta")
# 
# 
# pre_choice_results_da8 <- compile_results(regions = regions_to_combine,
...
write_csv(ofc_merged_results, 
          path(here(), "results", "single_regressions", "compiled_comb_only_ofc_theta_results_1_4_2022.csv"))
write_csv(cing_merged_results, 
          path(here(), "results", "single_regressions", "compiled_comb_only_cingulate_theta_results_1_4_2022.csv"))
