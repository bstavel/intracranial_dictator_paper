...
# Unified Analyses (Residuals)

This notebook takes the compiled results from the permutated regressions, does FDR correction, creates the supplementary tables for the residual control analysis for the unified results. Creates Supplemental Table 3. 
...
unified_hfa_data <- read_csv(path(here(), "results", "single_regressions",
                                  "compiled_unified_residual_ogpermutation_ofc_results_1_26_2022.csv"))
...
## preds to use ##
best_preds <- c("other_var_payoff", "self_var_payoff")
