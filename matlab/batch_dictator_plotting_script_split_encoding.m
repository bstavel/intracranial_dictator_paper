...
%% grab file name
% regressor_file = 'ofc_electrodes_other_var_clusters_left.csv'
% regressor_file = 'ofc_electrodes_other_var_clusters_right.csv'
% regressor_file = 'ofc_electrodes_other_var_clusters.csv'

% regressor_file = 'ofc_electrodes_both_var_clusters_left.csv'
% regressor_file = 'ofc_electrodes_both_var_clusters_right.csv'
regressor_file = 'ofc_electrodes_both_var_clusters.csv'
