...
%% grab file name
% regressor_file = 'ofc_electrodes_trial_type_right.csv'
% regressor_file = 'ofc_electrodes_trial_type_left.csv'
regressor_file = 'ofc_electrodes_trial_type.csv'
...
params.cmap = 'custom_trial_type' % 'linspecer' %'custom'; %'default'; % 'default', 'jet', 'parula', 'viridis', 'lines', summer: all, autumn: activation, winter: suppression, flipud INVERSION MAP
