...
%% grab file name
regressor_file = 'ofc_electrodes_both_var_clusters_prec_left.csv'
% regressor_file = 'ofc_electrodes_both_var_clusters_prec_right.csv'
% regressor_file = 'ofc_electrodes_both_var_clusters_prec.csv'
...
params.cmap = 'custom_split' % 'linspecer' %'custom_split'; %'default'; % 'default', 'jet', 'parula', 'viridis', 'lines', summer: all, autumn: activation, winter: suppression, flipud INVERSION MAP
NM_plotValOnAnat(patientList, params, workingDir, 0);

%%%% Presentation %%%%

%% grab file name
regressor_file = 'ofc_electrodes_both_var_clusters_pres_left.csv'
% regressor_file = 'ofc_electrodes_both_var_clusters_pres_right.csv'
% regressor_file = 'ofc_electrodes_both_var_clusters_pres.csv'
